...
#define ZL_DPLL_REFSEL_STATUS_STATE_FAST_LOCK	2
...
#define ZL_REG_DPLL_FAST_LOCK_CTRL		ZL_REG(12, 0x09, 1)
#define ZL_DPLL_FAST_LOCK_CTRL_MASTER_EN	BIT(0)
#define ZL_DPLL_FAST_LOCK_CTRL_FORCE_EN		BIT(1)
