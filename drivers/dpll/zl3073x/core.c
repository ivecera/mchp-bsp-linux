...
static const struct zl3073x_chip_info zl3073x_chip_ids[] = {
	...
	ZL_CHIP_INFO(0x2E93, 1, ZL3073X_FLAGS_B_SERIES),
	ZL_CHIP_INFO(0x2E94, 2, ZL3073X_FLAGS_B_SERIES),
	ZL_CHIP_INFO(0x2E95, 3, ZL3073X_FLAGS_B_SERIES),
	ZL_CHIP_INFO(0x2E96, 4, ZL3073X_FLAGS_B_SERIES),
	ZL_CHIP_INFO(0x2E97, 5, ZL3073X_FLAGS_B_SERIES),
	ZL_CHIP_INFO(0x3FC4, 2, ZL3073X_FLAGS_B_SERIES),
};
